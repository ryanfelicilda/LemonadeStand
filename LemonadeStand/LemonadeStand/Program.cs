    ...
    class Program
    {
        static void Main(string[] args)
        {
            Console.WriteLine("INSTRUCTIONS\n\n" +
                ...
                "Buy cups, lemons, sugar, and ice cubes, then set your recipe based on the weather conditions.\n" +
                "Start the basic recipe, but try to vary the recipe and see if ou can do better.\n" +
